...
namespace MainGame
{
	...
	constexpr u32 TRAIL_POINTS_RESOLUTION = 48;
	constexpr float MAX_NOTE_DURATION_NORMALIZED = 1.25f;
	constexpr u32 TRAIL_POINTS_COUNT = static_cast<u32>(TRAIL_POINTS_RESOLUTION * MAX_NOTE_DURATION_NORMALIZED);
